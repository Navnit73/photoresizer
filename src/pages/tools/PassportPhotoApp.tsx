              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-13">
                  ...
                  <p className="text-slate-600 dark:text-slate-300 text-sm max-w-xl mx-auto pb-3">
                    From your photo to a government-compliant print sheet ready for submission.
                  </p>
                </div>
                <div className="grid md:grid-cols-3 gap-2 mb-12">
                  <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-md">
                    ...
                    />
                    <div className="p-4">
                      <p className="text-sm font-bold text-slate-800 dark:text-slate-200">AI Processing</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Face detection & biometric alignment</p>
                    </div>
                  </div>
                  <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-md">
                    <img
                    ...
                    />
                    <div className="p-4">
                      <p className="text-sm font-bold text-slate-800 dark:text-slate-200">Final Output</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Compliant photo with white background</p>
                    </div>
                  </div>
                  <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-md">
                    ...
                    <div className="p-4">
                      <a href="http://localhost:8080/passport-photo-print-template-generator" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-slate-800 dark:text-slate-200 hover:text-primary transition-colors">
                        Print Template
                      </a>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">300 DPI print sheet with crop guides</p>
                    </div>
                  </div>
                </div>
              </div>
