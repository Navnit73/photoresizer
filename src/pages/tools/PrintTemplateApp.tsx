...
const PAPER_SIZES = {
  "4x6": { name: "4×6 inch", width: 101.6, height: 152.4 },
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      {!imageSrc ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 flex-col-reverse lg:flex-row">
          ...
          {/* Canvas Preview Area */}
          <div className="lg:col-span-8 bg-slate-200 rounded-2xl p-2 sm:p-8 flex items-center justify-center overflow-hidden min-h-[300px] lg:min-h-[500px] border border-slate-300 shadow-inner order-1 lg:order-2">
