  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 font-sans selection:bg-blue-100 selection:text-blue-900">
      <SEO 
        ...
        description="Complete guide for government exam photo and signature requirements. UPSC, SSC, IBPS, and State exam photo specifications explanations and resizing tips."
      />
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="text-center mb-20 relative">
          ...
          <div className="max-w-2xl mx-auto relative mb-12 group">
            ...
            <Input 
              type="text" 
              placeholder="Search guides (e.g., UPSC, 20KB, Passport)..." 
                ...
                <Card className="h-full hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col overflow-hidden rounded-2xl shadow-sm ring-1 ring-slate-200/50 dark:ring-slate-800">
                  ...
                  <CardHeader className="pb-4 pt-6 px-6 flex-1">
                    <div className="flex justify-between items-start mb-4">
                      <Badge variant="secondary" className="text-xs font-semibold bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-100 dark:border-blue-800/50 rounded-md px-2 py-1">
                        {post.category}
                      </Badge>
                    ...
                    <CardTitle className="text-xl font-bold leading-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors text-slate-900 dark:text-white">
                      {post.title}
                    </CardTitle>
                  </CardHeader>
                     ...
                     <div className="flex items-center justify-between pt-5 border-t border-slate-100 dark:border-slate-800">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-xs font-medium text-slate-500 dark:text-slate-400">
                                <span className="block text-[10px] uppercase text-slate-400 font-semibold tracking-wider">Size Limit</span>
                                {post.specifications.fileSize.split(" ")[0]} {post.specifications.fileSize.split(" ")[1]}
                            </div>
                        </div>
        ...
        <section className="mt-24 text-center bg-slate-900 dark:bg-black rounded-3xl p-10 md:p-20 text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-slate-300 text-lg md:text-xl mb-10 leading-relaxed">
              Our AI-powered tool automatically handles strict dimension and size requirements for all the exams listed above. Secure, fast, and free.
            </p>
            <Button 
              size="lg" 
