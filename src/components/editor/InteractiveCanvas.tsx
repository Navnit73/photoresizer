...
export function InteractiveCanvas({
  ...
  const onPointerMove = (e: React.PointerEvent) => {
    ...
    raf.current = requestAnimationFrame(() => updateCrop(e.clientX, e.clientY));
  };
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {ASPECT_RATIOS.map((ar) => (
              <Button
                ...
                size="sm"
                variant={
                  aspectRatio === ar.value && !isLocked ? "default" : "outline"
                }
            ...
            <Button
              ...
              className="h-7 px-2"
              title={
                isLocked ? "Unlock aspect ratio" : "Lock current aspect ratio"
              }
            >
              {isLocked ? (
