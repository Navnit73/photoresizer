...
const staticPages = [
  ...
  { path: '/passport-photo-maker', priority: '0.9', changefreq: 'weekly' },
  { path: '/passport-size-photo-maker', priority: '0.9', changefreq: 'weekly' },
  { path: '/passport-photo-app', priority: '0.9', changefreq: 'weekly' },
